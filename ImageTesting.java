...
public class ImageTesting implements Runnable {
    ...
    ImageTestingListener listener;
    public ImageTesting(File nueralNetwork, File realDir, File fakeDir) {
        this.nueralNetwork = nueralNetwork;
        this.realDir = realDir;
        this.fakeDir = fakeDir;
    }
    public void setListener(ImageTestingListener listener) {
